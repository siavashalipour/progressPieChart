...
// thread managers
+ (void)runOnAuxiliaryQueue:(void(^)(void))thread_block;
+ (void)runOnAuxiliaryQueue:(void(^)(void))thread_block withCompletionBlock:(void(^)(void))completion_block;
+ (void)runOnMainQueue:(void(^)(void))thread_block;
+ (void)runOnMainQueue:(void(^)(void))thread_block withCompletionBlock:(void(^)(void))completion_block;
